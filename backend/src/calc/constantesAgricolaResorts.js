...
// contaminação na planilha-fonte, corrigida em 2026-09-07 cruzando com o
// "Plano de Contas Resorts.xlsb" oficial (contas genuínas dos Resorts usam
// sempre código 41xxx/51xxx). Ver nota completa em
// frontend/src/OrcamentoARA.jsx, PACOTES_RESORTS. Total agora: 108 contas.
...
export const PLANO_CONTAS_RESORTS = {
  ...
  pessoal: [
    ...
    // oficial (as 6 abaixo, marcadas com a mesma nota) — ver
    // frontend/src/OrcamentoARA.jsx, PACOTES_RESORTS, para o racional completo.
  ...
  administrativo_utilidades: [
    ...
    // De/Para com o Samoa Villa (Book3.xlsx, 2026-09-08) — ver nota completa
    // no frontend.
